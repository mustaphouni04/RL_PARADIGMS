...
from stable_baselines3.common.vec_env import DummyVecEnv, VecMonitor, VecTransposeImage, VecVideoRecorder
...
def train_model(env, model_name, config):
    ...
    video_trigger = lambda x: x % 100_000 == 0
